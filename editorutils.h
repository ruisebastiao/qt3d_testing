...
public:
    ...
    Q_INVOKABLE Qt3DCore::QTransform* qentityTransform(Qt3DCore::QEntity *entity){
        return entityTransform(entity);
    }
    ...
    Q_INVOKABLE QMatrix4x4 qtotalAncestralTransform(Qt3DCore::QEntity *entity){
        return totalAncestralTransform(entity);
    }
